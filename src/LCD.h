...
//Extra Function for special Characters

void lcd_write_character()
{
	
	DATA_BUS=(DATA_BUS & 0x0F) | (0b10010000 & 0b11110000);
	CTL_BUS|=(1<<LCD_RS);
	CTL_BUS |=(1<<LCD_EN);
	_delay_ms(2);
	CTL_BUS &=~(1<<LCD_EN);
	_delay_ms(2);
	DATA_BUS= (DATA_BUS & 0x0F) | ((0b01100000 & 0b00001111)<<4);
	CTL_BUS |=(1<<LCD_EN);
	_delay_ms(2);
	CTL_BUS &=~(1<<LCD_EN);
	_delay_ms(2);
